  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="border-b border-gray-200">
        <div className="max-w-2xl mx-auto px-4">
          <nav className="flex space-x-8">
            <a href="#" className="py-3 border-b-3 border-blue-500 text-blue-600 text-sm font-medium">Text</a>
            <a href="#" className="py-3 text-gray-600 text-sm hover:text-gray-800">Images</a>
            <a href="#" className="py-3 text-gray-600 text-sm hover:text-gray-800">Videos</a>
            <a href="#" className="py-3 text-gray-600 text-sm hover:text-gray-800">More</a>
            <div className="flex-1"></div>
            <a href="#" className="py-3 text-gray-600 text-sm hover:text-gray-800">Agents</a>
          </nav>
        </div>
      </div>
      ...
      <main className="max-w-2xl mx-auto px-4 mt-6">
        {searchResults.length > 0 && <div className="text-gray-600 text-sm mb-6">
              ...
              <div className="flex items-start space-x-3">
                <div className="flex-1">
                  <div className="flex items-center mb-1">
                    ...
                    <div>
                      {/*@ts-ignore*/}
                      <a target='_blank' href={`https://arweave.net/raw/${result.entry.id}`} className="text-blue-600 text-sm">{`https://arweave.net/raw/${result.entry.id}`}</a>
                    </div>
                    {/* <MoreVertical className="w-4 h-4 text-gray-400 ml-auto opacity-0 group-hover:opacity-100 transition-opacity" /> */}
                  </div>
                  {/* <h3 className="text-xl text-blue-600 hover:underline cursor-pointer mb-1 leading-6">
                    {result.title}
                  </h3> */}
                  {/*@ts-ignore*/}
                  <p className="text-gray-600 text-sm leading-5">{result.entry.summary}</p>
                </div>
              </div>
            </div>
